...
const walletData: walletDataType[] = [
  {
    ...
    pubkey: {
      ...
      key: 'AkNVLtIlk2c3zweQXS6jyVshzVhAy0M59crUeksc2pak',
    },
    mnemonic:
  ...
  },
  {
    ...
    pubkey: {
      '@type': '/cosmos.crypto.secp256k1.PubKey',
      key: 'A0RRfnW/yIHOgFjGpknpT/j19OP3YMsXj6OhuCCHfyu6',
    },
    mnemonic:
  ...
  },
  {
    ...
    pubkey: {
      '@type': '/cosmos.crypto.secp256k1.PubKey',
      key: 'A5sEEVq3yKGF/pDihGjtSe3SElOd05zXzMxCBPMAhspC',
    },
    mnemonic:
  ...
  },
  {
    ...
    pubkey: {
      '@type': '/cosmos.crypto.secp256k1.PubKey',
      key: 'AweL0IVkZAHjmdSPJucxcln3AcPuMHD4EcnjKBFLZkcA',
    },
    mnemonic:
  ...
  },
  {
    ...
    pubkey: {
      '@type': '/cosmos.crypto.secp256k1.PubKey',
      key: 'A5aDi6tH57PDZossksf820HI+kVGO5etFqjGbFw/tACu',
    },
    mnemonic:
  ...
  },
  {
    ...
    pubkey: {
      '@type': '/cosmos.crypto.secp256k1.PubKey',
      key: 'AgZffLI+SEDH5qCrGoG4HjPy8AIDVmjGZJzy7L3YNkb9',
    },
    mnemonic:
  ...
  },
  {
    ...
    pubkey: {
      '@type': '/cosmos.crypto.secp256k1.PubKey',
      key: 'A65FjujcdnaFQutpnfkj82QSKtYOMBJPaW4pfTiERwMu',
    },
    mnemonic:
  ...
  },
  {
    ...
    pubkey: {
      '@type': '/cosmos.crypto.secp256k1.PubKey',
      key: 'A2Kc6ERRH6B4REjY6ryTO+ZdNbxuJATDVKXA89irZpKO',
    },
    mnemonic:
